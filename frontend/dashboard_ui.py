...
"")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("Icons/user.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        self.label_ventas = QtWidgets.QLabel(parent=self.page)
        self.label_ventas.setText("")
        self.label_ventas.setObjectName("label_ventas")
        self.verticalLayout_11.addWidget(self.label_ventas)
        icon11 = QtGui.QIcon()
        ...
        self.label_libros = QtWidgets.QLabel(parent=self.page_5)
        self.label_libros.setText("")
        self.label_libros.setObjectName("label_libros")
        self.verticalLayout_12.addWidget(self.label_libros)
        ...
        self.label_comentarios = QtWidgets.QLabel(parent=self.page_2)
        self.label_comentarios.setText("")
        self.label_comentarios.setObjectName("label_comentarios")
        self.verticalLayout_13.addWidget(self.label_comentarios)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "  Registrar Maestro"))
        self.bt_uno.setText(_translate("MainWindow", "   Registrar Alumno"))
